...
const ICON_3D = {
  ...
  rentas: {
    // 🏠 Rentas: icono descargado (casa + flecha circular), integrado inline.
    to: '/rentas',
    title: 'Rentas Moscú',
    ...
    svg: (
      <svg viewBox="0 0 48 48" className="w-full h-full" aria-hidden="true">
        ...
        <ellipse cx="24" cy="42" rx="14" ry="2" fill="#0f172a" opacity="0.13" />
        {/* Casa + flecha circular, centrada y escalada al marco 48×48 */}
        <g transform="translate(24 24) scale(0.082) translate(-257 -253.9)">
          <path d="M142.279,88.276V35.31h17.655V0H54.003v35.31h17.655v114.759l-49.364,42.805 c-7.477,6.63-2.781,18.988,7.212,18.988h42.152V476.69H54.003V512h405.998l0.071-35.31h-17.655V211.862h42.214 c9.869,0,14.504-12.209,7.124-18.759L288.684,12.959c-17.752-17.09-45.833-17.09-63.576,0L142.279,88.276z" fill="#0ea5e9"/>
          <path d="M398.279,317.793c0-78.009-63.232-141.241-141.241-141.241s-141.241,63.232-141.241,141.241 s63.232,141.241,141.241,141.241S398.279,395.802,398.279,317.793" fill="#ffffff"/>
          <g>
            <path d="M257.037,432.552c-4.873,0-8.828-3.955-8.828-8.828V211.862c0-4.873,3.955-8.828,8.828-8.828 c4.873,0,8.828,3.955,8.828,8.828v211.862C265.865,428.597,261.91,432.552,257.037,432.552" fill="#14b8a6"/>
            <path d="M257.037,414.897c-21.804,0-40.413-7.645-51.041-20.974c-3.037-3.814-2.419-9.375,1.395-12.412 c3.805-3.037,9.375-2.419,12.403,1.395c7.159,8.978,21.08,14.336,37.244,14.336c21.23,0,44.138-13.497,44.138-35.31 c0-21.124-22.819-35.31-44.138-35.31c-29.722,0-61.793-20.25-61.793-52.966s32.071-52.966,61.793-52.966 c22.131,0,40.254,7.45,51.041,20.974c3.037,3.814,2.419,9.375-1.395,12.412c-3.805,3.037-9.366,2.41-12.403-1.395 c-7.371-9.242-20.595-14.336-37.244-14.336c-21.319,0-44.138,14.186-44.138,35.31c0,21.813,22.908,35.31,44.138,35.31 c29.723,0,61.793,20.25,61.793,52.966S286.76,414.897,257.037,414.897" fill="#0f766e"/>
            <path d="M301.175,282.483c-4.873,0-8.828-3.955-8.828-8.828V220.69c0-4.873,3.955-8.828,8.828-8.828 s8.828,3.955,8.828,8.828v52.966C310.003,278.528,306.048,282.483,301.175,282.483" fill="#0f766e"/>
            <path d="M212.899,423.724c-4.873,0-8.828-3.955-8.828-8.828v-52.966c0-4.873,3.955-8.828,8.828-8.828 s8.828,3.955,8.828,8.828v52.966C221.727,419.769,217.772,423.724,212.899,423.724" fill="#0f766e"/>
          </g>
        </g>
      </svg>
    ),
  ...
  servicios: {
    ...
    svg: (
      <svg viewBox="0 0 48 48" className="w-full h-full" aria-hidden="true">
        {/* Sombra de suelo (acabado común) */}
        <ellipse cx="24" cy="42" rx="13" ry="2" fill="#0f172a" opacity="0.13" />
        {/* Engranajes centrados y escalados al marco 48×48 */}
        <g transform="translate(24 24) scale(0.046) translate(-515.2 -516.3)">
